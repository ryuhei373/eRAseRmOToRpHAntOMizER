...
const { input, eraserMotorPhantomized, twitterShareUrl } =
  useEraserMotorPhantomize()
</script>

<template>
  <Header />
  <section class="container px-5 py-24 mx-auto">
    <h1 class="eraser-motor-phantomized">
    ...
    <div class="
      ...
      <div class="relative flex-grow w-full">
        <input v-model="input" type="text" id="inputtedText" name="inputtedText" class="input-field" />
      </div>
      <a class="w-full sm:w-1/3" :href="twitterShareUrl" target="_blank">
        <button class="
              ...
              w-full
            ">
          <svg class="fill-white pr-1" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <path
...
.eraser-motor-phantomized {
  @apply text-4xl w-full mb-12 text-center text-gray-900 break-all;
