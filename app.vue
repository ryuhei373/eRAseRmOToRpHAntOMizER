...
export default {
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: '入力したテキストをeRAseRmOToRpHAntOM風にするだけのサイト' },
      { hid: 'og:type', property: 'og:type', content: 'website' },
      { hid: 'og:url', property: 'og:url', content: 'https://eloquent-volhard-d4031f.netlify.app' },
      { hid: 'og:title', property: 'og:title', content: 'eRAsoRmOToRpHAntOMizER' },
      { hid: 'og:description', property: 'og:description', content: '入力したテキストをeRAseRmOToRpHAntOM風にするだけのサイト'},
    ],
  },
